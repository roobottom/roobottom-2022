  ...
  eleventyComputed: {
    ...
    og: data => {
      return {
        ...
        image: {
          url: data.photo === undefined ? `https://ik.imagekit.io/roobottom/tr:ot-${encodeURIComponent(data.title.substring(0, 32))},otc-FFFFFF,otw-1280,ots-140,otf-og-font.ttf/og-backgrond.png` : transforms(data.photo[0].url, 'og'),
