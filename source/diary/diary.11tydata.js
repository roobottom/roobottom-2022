  ...
  eleventyComputed: {
    ...
    og: data => {
      return {
        ...
        image: {
          url: data.photo === undefined ? `https://ik.imagekit.io/roobottom/tr:ot-${encodeURIComponent(data.title.substring(0, 26))},otc-FFFFFF,otw-1280,ots-180,otf-Bely.ttf/og-backgrond.png` : transforms(process.env.SITE_URL + data.photo[0].url, 'og'),
