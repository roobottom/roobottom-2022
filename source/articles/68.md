...
{% figure '/assets/images/articles/68/scillonian.jpg', 'Looking back at the mainland from the stern of the RMV Scillonian III, somewhere in the Atlantic Ocean' %}
...
{% figure '/assets/images/articles/68/view.jpg', 'The view from Cath’s mum’s place', 'wide' %}
...
{% figure '/assets/images/articles/68/sea-king.jpg', 'Skipper Fraser Hicks pilots the Sea King into St.Mary’s harbour' %}
...
{% figure '/assets/images/articles/68/digging.jpg', 'My little excavation expert' %}
...
::: .gallery
{% figure '/assets/images/articles/68/fish.jpg', 'A "massive" fish' %}

{% figure '/assets/images/articles/68/jelly.jpg', 'A jelly fish' %}
:::
...
::: .gallery
{% figure '/assets/images/articles/68/juliets.jpg', 'The stunning views from Juliet’s Garden' %}

{% figure '/assets/images/articles/68/at-juliets.jpg', 'Katie and me enjoying a drink in the last of the evening sunshine at Juliet’s Garden' %}
:::
...
{% figure '/assets/images/articles/68/carting.jpg', 'Dave driving our formula-z cart' %}
...
{% figure '/assets/images/articles/68/fox-carpet.jpg', 'The fox carpet of your dreams' %}
...
{% figure '/assets/images/articles/68/gigs.jpg', 'Organised chaos on Town Beach as Gigs are landed after a race' %}
...
{% figure '/assets/images/articles/68/scilly-helicopter.jpg', 'British International Helicopters Sikorsky S-61 after landing on Tresco in 2008' %}
