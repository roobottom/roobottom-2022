...
tags:
  ...
  - portugal
  - roo
cover: /assets/images/articles/57/buddha-1.jpg
coverAlt: A giant golden Buddha statue in Buddha Eden, Bombarral
---
...
{% figure '/assets/images/articles/57/maratona-1.jpg', 'My family enjoying some lovely food at the Maratona Café' %}
...
{% figure '/assets/images/articles/57/albobaca.jpg', 'A panoramic shot of Katie and Roo exploring the monastery at Albobaça', 'wide' %}
...
::: .gallery
{% figure '/assets/images/articles/57/oceanarium-1.jpg', 'Roo looking in to one of the tanks at Lisbon Oceanarium' %}

{% figure '/assets/images/articles/57/oceanarium-2.jpg', 'Looking into one of the huge tanks of fish and corral at Lisbon Oceanarium' %}
:::
...
::: .gallery
{% figure '/assets/images/articles/57/buddha-1.jpg', 'A giant golden Buddha statue in Buddha Eden, Bombarral' %}

{% figure '/assets/images/articles/57/buddha-2.jpg', 'Katie and Roo pose by a huge reclining Thai Buddha at Buddha Eden, Bombarral' %}
:::
...
::: .gallery
{% figure '/assets/images/articles/57/park.jpg', 'Roo in the park in Caldas da Rainha' %}

{% figure '/assets/images/articles/57/beach.jpg', 'Katie holds Roo’s hand on an otherwise deserted beach' %}
:::
